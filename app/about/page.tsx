...
const AboutPage = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="py-24 max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-6">
                        <span className="text-gold-strong font-bold tracking-widest uppercase text-sm">About OneStreet</span>
                        ...
                        <div className="pt-4">
                            <Link href="/properties" className="btn-secondary">Explore Our Collection</Link>
                        </div>
                    </div>
            ...
            {/* Core Values Section */}
            <section className="py-20 bg-linear-to-l from-primary to-primary-light">
                <div className="max-w-7xl mx-auto px-4 space-y-15">
                    <div className="space-y-4 max-w-2xl">
                        <span className="text-gold-strong font-bold tracking-widest uppercase text-sm">Our Philosophy</span>
                    ...
                    <div
                        ...
                        {values.map((value, index) => (
                            <div key={index}
                                ...
                                <div
                                    className="text-gold-strong mb-8 transform group-hover:-translate-y-1 transition-transform duration-300">
                                    {value.icon}
                                </div>
                                <h3 className="text-highlight/90! text-2xl font-bold mb-4">{value.title}</h3>
            ...
            {/* CTA Section */}
            <section className="py-20 bg-primary/10 border-t border-accent/20 text-center space-y-8">
