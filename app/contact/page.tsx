        ...
        <div className="min-h-screen">
            ...
            <section className="max-w-7xl mx-auto px-4 -mt-10 mb-24">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    {/* Contact Form */}
                    <div className="lg:col-span-2 bg-white rounded-md shadow-xl border border-border p-8 md:p-12">
                        ...
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full px-4 py-3 rounded-lg border border-border focus:border-accent outline-none transition-colors"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select className="w-full px-4 py-3 rounded-lg border border-border focus:border-accent outline-none transition-colors bg-white">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea 
                                    ...
                                    className="w-full px-4 py-3 rounded-lg border border-border focus:border-accent outline-none transition-colors resize-none"
                                ></textarea>
                            </div>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        <div className="bg-white rounded-md border border-border p-8 shadow-sm space-y-8">
                            <h3 className="text-2xl border-b border-border pb-4">Information</h3>
            ...
            <section className="h-100 w-full bg-border relative overflow-hidden flex-center grayscale">
                ...
                <div className="relative z-10 bg-white p-6 rounded-lg shadow-2xl border border-border text-center">
                    ...
                    <p className="font-bold">Find us in Westlands</p>
                    <p className="text-xs text-muted">Visit our headquarters for a coffee and a chat.</p>
                </div>
            </section>
        </div>
    );
