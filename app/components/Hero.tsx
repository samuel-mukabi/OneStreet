...
const Hero = () => {
    return (
        <div className='h-[calc(100vh-5rem)] relative overflow-hidden'>
            ...
            <div
                className="absolute inset-0 z-20 flex-center -top-1/4 md:-top-1/2 pt-20 flex-col space-y-10  md:max-w-4xl mx-auto text-center px-4">
                <h1 className="text-6xl! md:text-8xl!">Where Exceptional Living Begins</h1>
