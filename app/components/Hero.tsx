    ...
    return (
        <div className='h-[calc(100vh-5rem)] relative overflow-hidden'>
            <div className="absolute inset-0">
                ...
                <Image src={'/images/Bungalow House Landscape.jpg'}
            ...
            <div className="absolute inset-0 z-20 flex-center -top-1/4 md:-top-1/2 pt-20 flex-col space-y-10  md:max-w-4xl mx-auto text-center px-4">
                ...
                <h5 className='max-w-2xl text-sm! md:text-lg!'>Discover an unparalleled collection of luxury properties curated by Kenya&#39;s most trusted real estate firm.</h5>
